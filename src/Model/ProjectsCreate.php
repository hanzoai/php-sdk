...
class ProjectsCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets upstream
     *
     * @param string|null $upstream Upstream/License credit the third-party work this project was published from. Taken from any caller: disclaiming authorship can only cost the publisher credit, so it needs no gate (see Project.Upstream).
     *
     * @return self
     */
