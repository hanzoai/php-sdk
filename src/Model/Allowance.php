 ...
 */
class Allowance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Allowance';
    ...
    */
     ...
     * Sets limit
     *
     * @param int|null $limit calls the plan allows per period; 0 = unbounded
     *
     * @return self
     */
     ...
     * Sets plan
     *
     * @param string|null $plan the tier the limit came from
     *
     * @return self
     */
    ...
    {
        if (is_null($resets)) {
            throw new \InvalidArgumentException('non-nullable resets cannot be null');
        }
     ...
     * Sets spent
     *
     * @param bool|null $spent the subject is at the limit
     *
     * @return self
     */
