 ...
 */
class SafeIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'safeIn';
    ...
    protected static $openAPITypes = [
        'document_ids' => 'string[]',
        'signers' => '\Hanzo\Cloud\Model\Signer[]'
    ];
    ...
    */
     ...
     * Sets document_ids
     *
     * @param string[]|null $document_ids DocumentIDs are data room document ids to raise a signature request over. Required.
     *
     * @return self
     */
     ...
     * Gets signers
     *
     * @return \Hanzo\Cloud\Model\Signer[]|null
     */
     ...
     * Sets signers
     *
     * @param \Hanzo\Cloud\Model\Signer[]|null $signers Signers are the recipients, each a name and an email. Required.
     *
     * @return self
     */
