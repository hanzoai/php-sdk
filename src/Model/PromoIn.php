 ...
 */
class PromoIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'promoIn';
    ...
    */
     ...
     * Sets active
     *
     * @param bool|null $active Active is the master switch: false parks the offer without deleting it.
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param string|null $end End is when the offer closes (RFC3339).
     *
     * @return self
     */
     ...
     * Sets percent_off
     *
     * @param int|null $percent_off PercentOff is the discount, 0-100.
     *
     * @return self
     */
     ...
     * Sets plans
     *
     * @param string[]|null $plans Plans are the plan ids the offer applies to.
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param string|null $start Start is when the offer opens (RFC3339).
     *
     * @return self
     */
