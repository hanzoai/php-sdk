 ...
 */
class IndexSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'indexSettings';
    ...
    */
     ...
     *
     * @param string[]|null $filterable_attributes FilterableAttributes are the document fields a search `filter` may constrain. A field not listed here cannot be filtered on.
     *
     * @return self
     */
