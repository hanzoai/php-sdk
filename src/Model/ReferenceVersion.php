...
/**
 * ReferenceVersion Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class ReferenceVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReferenceVersion';
    ...
    */
     ...
     * Sets as_of
     *
     * @param string|null $as_of AsOf is when the oldest of them was current, RFC 3339.
     *
     * @return self
     */
     ...
     * Sets refusal
     *
     * @param string|null $refusal Refusal is why it could not be consulted, when it could not.
     *
     * @return self
     */
     ...
     * Sets stale
     *
     * @param bool|null $stale Stale is whether it is past its freshness bound.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version Version is every contributing publisher and its content digest.
     *
     * @return self
     */
