...
class DocumentPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Hanzo\Cloud\Model\DocumentSummary[]',
        'disclaimer' => 'string'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \Hanzo\Cloud\Model\DocumentSummary[]|null $data Data are the documents, WITHOUT their rendered content — fetch one to read it.
     *
     * @return self
     */
