...
class Match implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets rank
     *
     * @param int|null $rank Rank is this document's 1-based position in THAT leg's own result list, before fusion — 1 is the leg's best hit. It is the only input to the fused score: RRF adds 1/(60+rank) per leg, which is why a document two legs ranked second beats one a single leg ranked first.
     *
     * @return self
     */
