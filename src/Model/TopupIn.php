...
class TopupIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $payment_method_id MethodID names a card the subject already saved, for the saved-card endpoint.
     *
     * @return self
     */
     ...
     * Sets source_id
     *
     * @param string|null $source_id SourceID is a single-use card token from the payment form, for the token endpoint. It is vaulted as part of the charge, so a caller never holds card numbers and this service never sees one.
     *
     * @return self
     */
