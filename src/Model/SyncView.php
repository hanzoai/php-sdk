...
class SyncView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets source
     *
     * @param \Hanzo\Cloud\Model\EndpointView|null $source source
     *
     * @return self
     */
     ...
     * Sets target
     *
     * @param \Hanzo\Cloud\Model\EndpointView|null $target target
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at bumped on every reconcile — the last-synced time
     *
     * @return self
     */
