 ...
 */
class SampleReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sampleReq';
    ...
    */
     ...
     * Sets machine
     *
     * @param string|null $machine Machine is the host whose meter read the window. Required.
     *
     * @return self
     */
     ...
     * Sets provider
     *
     * @param string|null $provider Provider is the upstream the account belongs to, e.g. anthropic. Required.
     *
     * @return self
     */
     ...
     * Sets resets_at
     *
     * @param string|null $resets_at ResetsAt is when the measured window rolls over, RFC3339. Empty is allowed; anything else that is not RFC3339 is refused.
     *
     * @return self
     */
     ...
     * Sets window_start
     *
     * @param string|null $window_start WindowStart is when the measured window opened, RFC3339. Empty is allowed; anything else that is not RFC3339 is refused.
     *
     * @return self
     */
