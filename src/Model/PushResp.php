 ...
 */
class PushResp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pushResp';
    ...
    */
     ...
     * Sets branch
     *
     * @param string|null $branch Branch is the branch that was advanced, resolved (never empty).
     *
     * @return self
     */
     ...
     * Sets clone_url
     *
     * @param string|null $clone_url CloneURL is the repo's HTTPS remote.
     *
     * @return self
     */
     ...
     * Sets commit
     *
     * @param string|null $commit Commit is the new commit's full hash.
     *
     * @return self
     */
     ...
     * Sets ssh_url
     *
     * @param string|null $ssh_url SSHURL is the repo's scp-style SSH remote.
     *
     * @return self
     */
