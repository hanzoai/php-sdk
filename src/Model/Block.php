...
class Block implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('text_en', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['text_en'];
    }

    /**
     * Sets text_en
     *
     * @param string|null $text_en text_en
     *
     * @return self
     */
    ...
    {
        if (is_null($text_en)) {
            throw new \InvalidArgumentException('non-nullable text_en cannot be null');
        }
        $this->container['text_en'] = $text_en;
