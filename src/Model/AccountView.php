 ...
 */
class AccountView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'accountView';
    ...
    */
     ...
     * Sets address
     *
     * @param string|null $address Address is the ledger account address (\"org:acme:wallet\", \"fund:reserve\", …).
     *
     * @return self
     */
     ...
     * Sets balance_cents
     *
     * @param int|null $balance_cents BalanceCents is that account's signed balance in minor units.
     *
     * @return self
     */
