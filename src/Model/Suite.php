...
class Suite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['benchmarks'] === null) {
            $invalidProperties[] = "'benchmarks' can't be null";
        }
     ...
     * Sets attempts
     *
     * @param int|null $attempts Attempts is how many times to try each item; the harness's default applies when it is omitted.
     *
     * @return self
     */
     ...
     * Sets benchmarks
     *
     * @param string[] $benchmarks Benchmarks are the catalog ids to run. At least one is required, and every id must be in the catalog.
     *
     * @return self
     */
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint Endpoint is your own chat-completions URL, for benchmarking a model this arena does not host. Either this or model is required.
     *
     * @return self
     */
     ...
     * Sets model
     *
     * @param string|null $model Model is the catalog model id to run. Either this or endpoint is required.
     *
     * @return self
     */
