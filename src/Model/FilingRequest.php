...
/**
 * FilingRequest Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class FilingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'filingRequest';
    ...
    */
     ...
     * Sets document_ids
     *
     * @param string[]|null $document_ids DocumentIDs are the documents to file. At least one is required, and every one must belong to the caller's org — a filing can never reach across orgs.
     *
     * @return self
     */
     ...
     * Sets jurisdiction
     *
     * @param string|null $jurisdiction Jurisdiction is the state or agency the filing is for, e.g. \"DE\".
     *
     * @return self
     */
