...
class Position implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets character
     *
     * @param int|null $character Character is a 0-based UTF-16 code-unit offset within Line, per the LSP specification: not a byte offset and not a rune index. An emoji before the cursor counts as one here and as two in Go's arithmetic.
     *
     * @return self
     */
     ...
     * Sets line
     *
     * @param int|null $line Line is 0-BASED, per the LSP specification — one less than the line an editor shows a human.
     *
     * @return self
     */
