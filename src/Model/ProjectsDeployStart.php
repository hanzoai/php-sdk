...
/**
 * ProjectsDeployStart Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class ProjectsDeployStart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'projectsDeployStart';
    ...
    */
     ...
     * Sets slug
     *
     * @param string|null $slug Slug is the site to deploy, from the path.
     *
     * @return self
     */
