...
class LLM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets available
     *
     * @param bool|null $available Available is false when the warehouse was not connected or a query blipped. The totals below are then honest zeros, NOT measured ones.
     *
     * @return self
     */
     ...
     *
     * @param int|null $completion_tokens CompletionTokens is the output half.
     *
     * @return self
     */
     ...
     * Sets cost_cents
     *
     * @param int|null $cost_cents CostCents is what they cost the org, in US cents. This IS a Hanzo charge.
     *
     * @return self
     */
     ...
     * Sets models
     *
     * @param int|null $models Models is how many distinct models were used.
     *
     * @return self
     */
     ...
     * Sets prompt_tokens
     *
     * @param int|null $prompt_tokens PromptTokens is the input half of that total.
     *
     * @return self
     */
     ...
     * Sets requests
     *
     * @param int|null $requests Requests is how many completions the org made in the window.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source Source names the warehouse table the totals came from.
     *
     * @return self
     */
     ...
     * Sets tokens
     *
     * @param int|null $tokens Tokens is the total tokens those completions consumed.
     *
     * @return self
     */
