...
/**
 * SetReferenceOut Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class SetReferenceOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetReferenceOut';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('written', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets overrides
     *
     * @param int|null $overrides Overrides is how many your org now holds in this set.
     *
     * @return self
     */
     ...
     * Sets set
     *
     * @param string|null $set Set is the set written in.
     *
     * @return self
     */
     ...
     * Sets written
     *
     * @param int|null $written Written is how many entries this call wrote.
     *
     * @return self
     */
    ...
    {
        if (is_null($written)) {
            throw new \InvalidArgumentException('non-nullable written cannot be null');
        }
