 ...
 */
class RollbackReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rollbackReq';
    ...
    */
     ...
     * Sets deployment_id
     *
     * @param string|null $deployment_id DeploymentID is the deployment to redeploy. Omit it to return to the previous release.
     *
     * @return self
     */
