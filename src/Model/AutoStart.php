 ...
 */
class AutoStart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'autoStart';
    ...
    */
     ...
     * Sets flow
     *
     * @param string|null $flow Flow is the id of the flow to run.
     *
     * @return self
     */
