...
/**
 * GithubForkOut Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class GithubForkOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'githubForkOut';
    ...
    */
     ...
     * Sets clone_url
     *
     * @param string|null $clone_url CloneURL is the fork's https git remote. GitHub populates a new fork in the background, so a clone issued the moment this answers can still find it empty.
     *
     * @return self
     */
     ...
     * Sets default_branch
     *
     * @param string|null $default_branch DefaultBranch is the branch the fork checks out, inherited from upstream.
     *
     * @return self
     */
     ...
     * Sets existing
     *
     * @param bool|null $existing Existing reports that the fork was already there. GitHub answers 202 either way, so without this a caller cannot tell \"made you one\" from \"you had one\".
     *
     * @return self
     */
     ...
     * Sets full_name
     *
     * @param string|null $full_name FullName is the fork's \"owner/repo\". The owner is the account it landed in — the request's org, or the installation's own account when none was named.
     *
     * @return self
     */
     ...
     * Sets html_url
     *
     * @param string|null $html_url HTMLURL is the fork's page on github.com.
     *
     * @return self
     */
