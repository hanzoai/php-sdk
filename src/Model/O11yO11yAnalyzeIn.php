...
/**
 * O11yO11yAnalyzeIn Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class O11yO11yAnalyzeIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'o11y.O11yAnalyzeIn';
    ...
    */
     ...
     * Sets query
     *
     * @param string $query Query is the query text. Required.
     *
     * @return self
     */
     ...
     * Sets query_type
     *
     * @param string $query_type QueryType says which language the query is in — promql or the datastore's SQL dialect. Required.
     *
     * @return self
     */
