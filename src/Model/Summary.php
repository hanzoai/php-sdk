...
class Summary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets calls
     *
     * @param int|null $calls Calls is how many calls this org has placed or received, over its whole history — a running total, not a window.
     *
     * @return self
     */
     ...
     * Sets messages
     *
     * @param int|null $messages Messages is the same running total for messages.
     *
     * @return self
     */
     ...
     * Sets numbers
     *
     * @param int|null $numbers Numbers is how many numbers this org holds right now.
     *
     * @return self
     */
