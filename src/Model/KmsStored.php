 ...
 */
class KmsStored implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'kmsStored';
    ...
    */
     ...
     * Sets env
     *
     * @param string|null $env Env is the environment the secret was written under.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name is the secret's name.
     *
     * @return self
     */
     ...
     * Sets stored
     *
     * @param bool|null $stored Stored is true; a write confirms by not failing.
     *
     * @return self
     */
