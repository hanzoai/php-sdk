 ...
 */
class ChainStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chainStatus';
    ...
    */
     ...
     * Sets height
     *
     * @param int|null $height Height is the latest block, omitted when the chain did not answer rather than reported as zero — a zero height is a real value on a fresh chain.
     *
     * @return self
     */
     ...
     * Sets live
     *
     * @param bool|null $live Live is whether the upstream answered eth_blockNumber.
     *
     * @return self
     */
