 ...
 */
class ReadingReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'readingReq';
    ...
    */
     ...
     * Sets account
     *
     * @param string|null $account Account is the provider-side account the sample belongs to.
     *
     * @return self
     */
     ...
     *
     * @param int|null $cached_input_tokens CachedInputTokens is the window's cached-prompt-token count.
     *
     * @return self
     */
     ...
     * Sets confidence
     *
     * @param string|null $confidence Confidence says how real the counters are, as the meter graded itself.
     *
     * @return self
     */
     ...
     * Sets cost_cents
     *
     * @param int|null $cost_cents CostCents is the window's spend in cents, as the provider's meter states it.
     *
     * @return self
     */
     ...
     *
     * @param int|null $cost_limit_cents CostLimitCents is the window's spend cap in cents, when the meter knows one.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Currency is the ISO currency the cost fields are stated in.
     *
     * @return self
     */
     ...
     * Sets input_tokens
     *
     * @param int|null $input_tokens InputTokens is the window's prompt-token count.
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind Kind is subscription or apikey; anything else is refused.
     *
     * @return self
     */
     ...
     * Sets lane
     *
     * @param string|null $lane Lane names the meter's own lane label for this measurement.
     *
     * @return self
     */
     ...
     * Sets machine
     *
     * @param string|null $machine Machine is the machine the collector observed the account on. Required.
     *
     * @return self
     */
     ...
     * Sets output_tokens
     *
     * @param int|null $output_tokens OutputTokens is the window's completion-token count.
     *
     * @return self
     */
     ...
     * Sets plan
     *
     * @param string|null $plan Plan is the provider plan label the account is on.
     *
     * @return self
     */
     ...
     * Sets provider
     *
     * @param string|null $provider Provider is the AI provider whose meter reported this sample. Required.
     *
     * @return self
     */
     ...
     * Sets requests
     *
     * @param int|null $requests Requests is the window's request count.
     *
     * @return self
     */
     ...
     * Sets resets_at
     *
     * @param string|null $resets_at ResetsAt is when the window resets, RFC 3339, bounded.
     *
     * @return self
     */
     ...
     * Sets synthetic
     *
     * @param bool|null $synthetic Synthetic marks a sample the collector derived rather than observed.
     *
     * @return self
     */
     ...
     * Sets total_tokens
     *
     * @param int|null $total_tokens TotalTokens is the window's total token count.
     *
     * @return self
     */
     ...
     * Sets used_pct
     *
     * @param float|null $used_pct UsedPct is how much of the window's allowance is consumed, clamped 0..100.
     *
     * @return self
     */
     ...
     * Sets window
     *
     * @param string|null $window Window is the window class, one of 6h, day, week, month; anything else is refused rather than silently reclassified.
     *
     * @return self
     */
     ...
     * Sets window_minutes
     *
     * @param int|null $window_minutes WindowMinutes is the window's length as the meter reported it.
     *
     * @return self
     */
     ...
     * Sets window_start
     *
     * @param string|null $window_start WindowStart is when the measured window opened, RFC 3339, bounded to a sane interval around now.
     *
     * @return self
     */
