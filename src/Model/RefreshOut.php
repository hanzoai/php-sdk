 ...
 */
class RefreshOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'refreshOut';
    ...
    */
     ...
     * Sets connector
     *
     * @param \Hanzo\Cloud\Model\ConnView|null $connector Connection is the connector with its new expiry.
     *
     * @return self
     */
     ...
     * Sets refreshed
     *
     * @param bool|null $refreshed Refreshed is always true — a failed rotation is an HTTP error.
     *
     * @return self
     */
