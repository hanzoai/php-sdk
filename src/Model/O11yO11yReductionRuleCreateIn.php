...
/**
 * O11yO11yReductionRuleCreateIn Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class O11yO11yReductionRuleCreateIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'o11y.O11yReductionRuleCreateIn';
    ...
    */
     ...
     * Sets labels
     *
     * @param string[] $labels Labels are the label names the rule matches. Required, at least one.
     *
     * @return self
     */
     ...
     * Sets match_type
     *
     * @param string $match_type MatchType is drop or keep: drop the named labels, or keep only them. Required.
     *
     * @return self
     */
     ...
     * Sets metric_name
     *
     * @param string $metric_name MetricName is the metric the rule governs; one rule per metric. Required.
     *
     * @return self
     */
