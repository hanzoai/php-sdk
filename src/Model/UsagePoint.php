...
class UsagePoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets requests
     *
     * @param int|null $requests Requests is how many LLM calls fell in this bucket.
     *
     * @return self
     */
     ...
     * Sets t
     *
     * @param string|null $t T is the bucket's start, RFC3339 UTC, aligned to the interval.
     *
     * @return self
     */
