...
class JournalEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'kind' => 'string',
        'memo' => 'string',
        'postings' => '\Hanzo\Cloud\Model\Posting[]',
        'program' => 'string',
        'ref' => 'string'
    ];
    ...
    */
     ...
     * Gets postings
     *
     * @return \Hanzo\Cloud\Model\Posting[]|null
     */
     ...
     * Sets postings
     *
     * @param \Hanzo\Cloud\Model\Posting[]|null $postings postings
     *
     * @return self
     */
     ...
     * Sets program
     *
     * @param string|null $program referral|affiliate|author for payouts; \"\" otherwise
     *
     * @return self
     */
     ...
     * Sets ref
     *
     * @param string|null $ref idempotency ref (unique within Kind+Program)
     *
     * @return self
     */
