...
/**
 * AccountsTotal Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class AccountsTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountsTotal';
    ...
    */
     ...
     * Sets accounts
     *
     * @param int|null $accounts Accounts is how many linked accounts the total folds.
     *
     * @return self
     */
     ...
     *
     * @param int|null $completion_tokens CompletionTokens is the total completion-token count.
     *
     * @return self
     */
     ...
     * Sets cost_cents
     *
     * @param int|null $cost_cents CostCents is the total cost in cents.
     *
     * @return self
     */
     ...
     * Sets prompt_tokens
     *
     * @param int|null $prompt_tokens PromptTokens is the total prompt-token count.
     *
     * @return self
     */
     ...
     * Sets requests
     *
     * @param int|null $requests Requests is the total request count the gateway routed.
     *
     * @return self
     */
     ...
     * Sets total_tokens
     *
     * @param int|null $total_tokens TotalTokens is the total token count.
     *
     * @return self
     */
