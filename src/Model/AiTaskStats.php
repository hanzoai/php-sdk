 ...
 */
class AiTaskStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ai.TaskStats';
    ...
    */
     ...
     * Sets models
     *
     * @param array<string,int>|null $models models
     *
     * @return self
     */
