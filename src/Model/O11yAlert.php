 ...
 */
class O11yAlert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'o11y.Alert';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('generator_url', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['generator_url'];
    }

    /**
     * Sets generator_url
     *
     * @param string|null $generator_url generator_url
     *
     * @return self
     */
    public function setGeneratorUrl($generator_url)
    {
        if (is_null($generator_url)) {
            throw new \InvalidArgumentException('non-nullable generator_url cannot be null');
        }
        $this->container['generator_url'] = $generator_url;
