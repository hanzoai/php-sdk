...
/**
 * O11yO11yMetricInspectIn Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class O11yO11yMetricInspectIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'o11y.O11yMetricInspectIn';
    ...
    */
     ...
     * Sets end
     *
     * @param int $end End is the end of the window as a Unix timestamp in milliseconds, at most thirty minutes after start. Required.
     *
     * @return self
     */
     ...
     * Sets filter
     *
     * @param \Hanzo\Cloud\Model\O11yO11yMetricFilter|null $filter Filter narrows the series returned.
     *
     * @return self
     */
     ...
     * Sets metric_name
     *
     * @param string $metric_name MetricName is the metric to inspect. Required.
     *
     * @return self
     */
