...
/**
 * O11yInstallIntegrationRequest Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class O11yInstallIntegrationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'o11y.InstallIntegrationRequest';
    ...
    */
     ...
     * Sets config
     *
     * @param array<string,object>|null $config config
     *
     * @return self
     */
