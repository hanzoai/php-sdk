 ...
 */
class RestartRef implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'restartRef';
    ...
    */
     ...
     * Sets app
     *
     * @param string|null $app App is the service's CR name, from the path. It must be a DNS-1123 label.
     *
     * @return self
     */
