...
/**
 * StreamUpdate Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class StreamUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'streamUpdate';
    ...
    */
     ...
     * Sets stream
     *
     * @param string|null $stream Stream is the stream to update, from the path.
     *
     * @return self
     */
