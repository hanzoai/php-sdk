...
/**
 * GithubPagesUpdateReq Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class GithubPagesUpdateReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'githubPagesUpdateReq';
    ...
    */
     ...
     * Sets branch
     *
     * @param string|null $branch Branch switches the legacy source branch. Empty leaves the source alone.
     *
     * @return self
     */
     ...
     * Sets build_type
     *
     * @param string|null $build_type BuildType switches the builder: \"legacy\" or \"workflow\". Empty leaves it.
     *
     * @return self
     */
     ...
     * Sets cname
     *
     * @param string|null $cname CNAME is the custom domain. Omit to leave it alone, \"\" to clear it, or a valid FQDN to set it.
     *
     * @return self
     */
     ...
     * Sets https_enforced
     *
     * @param bool|null $https_enforced HTTPSEnforced toggles GitHub's enforce-HTTPS bit. Omit to leave it alone.
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string|null $path Path is the source directory to pair with Branch: \"/\" (the default) or \"/docs\". Read only when Branch is given.
     *
     * @return self
     */
     ...
     * Sets repo
     *
     * @param string|null $repo Repo is the repository, from the :repo path segment.
     *
     * @return self
     */
