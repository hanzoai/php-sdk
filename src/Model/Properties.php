...
class Properties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('collected_time', $data ?? [], null);
    ...
    */
     ...
     * Sets collected_time
     *
     * @param string|null $collected_time collected_time
     *
     * @return self
     */
    public function setCollectedTime($collected_time)
    {
        if (is_null($collected_time)) {
            throw new \InvalidArgumentException('non-nullable collected_time cannot be null');
        }
