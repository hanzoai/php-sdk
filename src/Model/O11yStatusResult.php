...
/**
 * O11yStatusResult Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class O11yStatusResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'o11y.statusResult';
    ...
    protected static $openAPITypes = [
        'checked_at' => 'string',
        'deployments' => '\Hanzo\Cloud\Model\O11yDeployment[]',
        'latency_ms' => 'int',
        'product' => 'string',
        'source' => 'string',
        'up' => 'bool'
    ...
    */
     ...
     * Sets checked_at
     *
     * @param string|null $checked_at CheckedAt is when this answer was measured, RFC3339 UTC.
     *
     * @return self
     */
     ...
     * Gets deployments
     *
     * @return \Hanzo\Cloud\Model\O11yDeployment[]|null
     */
     ...
     * Sets deployments
     *
     * @param \Hanzo\Cloud\Model\O11yDeployment[]|null $deployments Deployments is the per-replica inventory behind the verdict. Empty means the telemetry store reported none, not that the service runs on none.
     *
     * @return self
     */
     ...
     * Sets latency_ms
     *
     * @param int|null $latency_ms LatencyMs is the health probe's round trip in MILLISECONDS, time-boxed at two seconds. It is 0 when no probe answered, which is not a fast service.
     *
     * @return self
     */
     ...
     * Sets product
     *
     * @param string|null $product Product is the service this answer is about, echoed back.
     *
     * @return self
     */
     ...
     * Sets up
     *
     * @param bool|null $up Up is true when the health probe succeeded OR any replica reports up, so a service reachable by either route reads up. Read Source to know which.
     *
     * @return self
     */
