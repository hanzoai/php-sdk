...
/**
 * CodingStarted Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class CodingStarted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CodingStarted';
    ...
    */
    ...
    {
        if (is_null($routed)) {
            throw new \InvalidArgumentException('non-nullable routed cannot be null');
        }
