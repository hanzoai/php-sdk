...
/**
 * UsageWindowView Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class UsageWindowView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usageWindowView';
    ...
    */
     ...
     * Sets account
     *
     * @param string|null $account Account is the linked provider account the window belongs to.
     *
     * @return self
     */
     ...
     *
     * @param int|null $cached_input_tokens CachedInputTokens is the prompt tokens served from the provider's cache; omitted when unknown.
     *
     * @return self
     */
     ...
     * Sets confidence
     *
     * @param string|null $confidence Confidence says how much the counters beside it mean — a meter that reported only a percentage leaves them at zero, and this is how a reader tells that from a true zero.
     *
     * @return self
     */
     ...
     * Sets cost_cents
     *
     * @param int|null $cost_cents CostCents is what the window cost on the PROVIDER's own plan, in US cents. It is not a Hanzo charge.
     *
     * @return self
     */
     ...
     * Sets input_tokens
     *
     * @param int|null $input_tokens InputTokens is prompt tokens consumed in the window; omitted when unknown.
     *
     * @return self
     */
     ...
     * Sets lane
     *
     * @param string|null $lane Lane is the meter lane this instance belongs to, e.g. a provider's own rolling-window meter.
     *
     * @return self
     */
     ...
     * Sets machine
     *
     * @param string|null $machine Machine is the host whose meter reported the window.
     *
     * @return self
     */
     ...
     * Sets output_tokens
     *
     * @param int|null $output_tokens OutputTokens is completion tokens produced in the window; omitted when unknown.
     *
     * @return self
     */
     ...
     * Sets requests
     *
     * @param int|null $requests Requests is how many requests were made in the window; omitted when the meter did not report it.
     *
     * @return self
     */
     ...
     * Sets resets_at
     *
     * @param string|null $resets_at ResetsAt is when this window rolls over, RFC3339 UTC; omitted when unknown.
     *
     * @return self
     */
     ...
     * Sets synthetic
     *
     * @param bool|null $synthetic Synthetic marks an instance the meter inferred rather than read.
     *
     * @return self
     */
     ...
     * Sets total_tokens
     *
     * @param int|null $total_tokens TotalTokens is the window's total tokens; omitted when unknown.
     *
     * @return self
     */
     ...
     * Sets window
     *
     * @param string|null $window Window is the window class: 6h, day, week or month.
     *
     * @return self
     */
     ...
     * Sets window_minutes
     *
     * @param int|null $window_minutes WindowMinutes is the window's real length in minutes when the meter reported one; omitted when it did not.
     *
     * @return self
     */
     ...
     * Sets window_start
     *
     * @param string|null $window_start WindowStart is when this window opened, RFC3339 UTC; omitted when unknown.
     *
     * @return self
     */
