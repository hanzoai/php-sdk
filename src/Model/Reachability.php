 ...
 */
class Reachability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reachability';
    ...
    */
     ...
     * Sets configured
     *
     * @param bool|null $configured Configured is whether the wholesale credentials are present at all.
     *
     * @return self
     */
     ...
     * Sets env
     *
     * @param string|null $env Env is the registrar environment. It is the fact that decides whether money moves: only \"prod\" reaches the live, billable registrar — anything else, including unset, is the sandbox.
     *
     * @return self
     */
     ...
     * Sets reachable
     *
     * @param bool|null $reachable Reachable is whether the registrar accepted those credentials on a live call made while the caller waited.
     *
     * @return self
     */
     ...
     * Sets registrar
     *
     * @param string|null $registrar Registrar names the wholesale registrar behind it.
     *
     * @return self
     */
     ...
     * Sets service
     *
     * @param string|null $service Service names the subsystem answering.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status is \"ok\" when a live call succeeded, else \"degraded\".
     *
     * @return self
     */
