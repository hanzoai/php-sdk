...
class Receipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount
     *
     * @param string|null $amount exact 18-dp USD (money.Amount string)
     *
     * @return self
     */
     ...
     * Sets from
     *
     * @param string|null $from payer address
     *
     * @return self
     */
     ...
     * Sets payee
     *
     * @param string|null $payee recipient address
     *
     * @return self
     */
     ...
     * Sets payee_org
     *
     * @param string|null $payee_org payee_org
     *
     * @return self
     */
     ...
     * Sets payer
     *
     * @param string|null $payer payer ORG (the debited ledger)
     *
     * @return self
     */
     ...
     * Sets settled_at
     *
     * @param int|null $settled_at settled_at
     *
     * @return self
     */
     ...
     * Sets settled_via
     *
     * @param string|null $settled_via \"ledger\" (live) | \"chain\" (seam)
     *
     * @return self
     */
