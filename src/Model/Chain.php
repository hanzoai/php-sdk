...
class Chain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets chain_id
     *
     * @param int|null $chain_id ChainID is the EIP-155 id, so a caller can check it matches the wallet they are about to sign with.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id ID is the URL name: the value of :chain.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name is for humans.
     *
     * @return self
     */
