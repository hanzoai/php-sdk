 ...
 */
class JobCanceled implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'jobCanceled';
    ...
    */
     ...
     * Sets canceled
     *
     * @param string|null $canceled Canceled is the job id that was canceled.
     *
     * @return self
     */
     ...
     * Sets run
     *
     * @param string|null $run Run is the run id the cancel was applied to.
     *
     * @return self
     */
