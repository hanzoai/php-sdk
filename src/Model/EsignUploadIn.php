...
/**
 * EsignUploadIn Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class EsignUploadIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'esignUploadIn';
    ...
    */
     ...
     * Sets pdf_base64
     *
     * @param mixed|null $pdf_base64 pdf_base64
     *
     * @return self
     */
     ...
     * Sets signing_order
     *
     * @param mixed|null $signing_order signing_order
     *
     * @return self
     */
    public function setSigningOrder($signing_order)
    {
        if (is_null($signing_order)) {
            array_push($this->openAPINullablesSetToNull, 'signing_order');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signing_order', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
