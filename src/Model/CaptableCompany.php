...
/**
 * CaptableCompany Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class CaptableCompany implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'captableCompany';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('incorporation_type', $data ?? [], null);
    ...
    */
     ...
     * Sets created_at
     *
     * @param int|null $created_at CreatedAt is when the company row was seeded, in unix milliseconds.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id ID is the company id, which is the tenant's own org id.
     *
     * @return self
     */
     ...
     *
     * @param string|null $incorporation_country IncorporationCountry is the ISO country the entity is incorporated in.
     *
     * @return self
     */
     ...
     *
     * @param string|null $incorporation_state IncorporationState is the state or province of incorporation.
     *
     * @return self
     */
     ...
     *
     * @param string|null $incorporation_type IncorporationType is the entity kind, e.g. LLC or C_CORP.
     *
     * @return self
     */
    public function setIncorporationType($incorporation_type)
    {
        if (is_null($incorporation_type)) {
            throw new \InvalidArgumentException('non-nullable incorporation_type cannot be null');
        }
     ...
     * Sets name
     *
     * @param string|null $name Name is the company's legal name.
     *
     * @return self
     */
     ...
     * Sets public_id
     *
     * @param string|null $public_id PublicID is the company's shareable public identifier.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param int|null $updated_at UpdatedAt is when the company row last changed, in unix milliseconds.
     *
     * @return self
     */
