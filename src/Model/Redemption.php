...
class Redemption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets plan
     *
     * @param string|null $plan Plan and Seats are what was redeemed against. Both are DERIVED server-side — Plan from the org's live paid subscription, Seats from claimSeats — and neither is ever read from the request.
     *
     * @return self
     */
