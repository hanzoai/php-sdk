...
class Health implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('subsystem', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets ok
     *
     * @param bool|null $ok OK is true whenever this route answers at all: reaching the handler IS the proof that the routes are registered and dispatching.
     *
     * @return self
     */
     ...
     * Sets subsystem
     *
     * @param string|null $subsystem Subsystem names what answered, so a health response read out of context still says which surface it came from.
     *
     * @return self
     */
    public function setSubsystem($subsystem)
    {
        if (is_null($subsystem)) {
            throw new \InvalidArgumentException('non-nullable subsystem cannot be null');
        }
