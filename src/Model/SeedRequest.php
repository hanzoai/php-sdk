 ...
 */
class SeedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'seedRequest';
    ...
    */
     ...
     * Sets amount_cents
     *
     * @param int|null $amount_cents AmountCents is the capital to inject, in minor units. Must be > 0.
     *
     * @return self
     */
     ...
     * Sets memo
     *
     * @param string|null $memo Memo is the operator's note on the entry. Empty takes \"reserve capital injection\".
     *
     * @return self
     */
     ...
     * Sets ref
     *
     * @param string|null $ref Ref is an idempotency key. Without one each seed is a distinct injection.
     *
     * @return self
     */
