...
class ReferenceSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets kind
     *
     * @param string|null $kind Kind is how the baseline comes to exist: fetch (downloaded from a publisher), local (computed here), attest (held by the component that screens against it, freshness reported), or seam (declared and NOT held, because the source needs a licence we do not have).
     *
     * @return self
     */
