 ...
 */
class StreamWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'streamWrite';
    ...
    */
     ...
     * Sets discard
     *
     * @param string|null $discard discard
     *
     * @return self
     */
     ...
     * Sets max_bytes
     *
     * @param int|null $max_bytes max_bytes
     *
     * @return self
     */
     ...
     * Sets max_msgs
     *
     * @param int|null $max_msgs max_msgs
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name is the stream's name within the org: 1–64 of [A-Za-z0-9_], no dash.
     *
     * @return self
     */
     ...
     * Sets retention
     *
     * @param string|null $retention retention
     *
     * @return self
     */
