 ...
 */
class ServicePort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServicePort';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('node_port', $data ?? [], null);
    ...
    */
     ...
     * Sets node_port
     *
     * @param int|null $node_port node_port
     *
     * @return self
     */
    public function setNodePort($node_port)
    {
        if (is_null($node_port)) {
            throw new \InvalidArgumentException('non-nullable node_port cannot be null');
        }
