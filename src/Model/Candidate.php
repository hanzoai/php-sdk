...
class Candidate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('is_hit', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['is_hit'];
    }

    /**
     * Sets is_hit
     *
     * @param bool|null $is_hit is_hit
     *
     * @return self
     */
    ...
    {
        if (is_null($is_hit)) {
            throw new \InvalidArgumentException('non-nullable is_hit cannot be null');
        }
        $this->container['is_hit'] = $is_hit;
