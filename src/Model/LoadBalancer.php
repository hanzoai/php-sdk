...
class LoadBalancer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('droplets', $data ?? [], null);
        ...
        $this->setIfExists('size_unit', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['droplets'];
    }

    /**
     * Sets droplets
     *
     * @param int|null $droplets droplets
     *
     * @return self
     */
    public function setDroplets($droplets)
    {
        if (is_null($droplets)) {
            throw new \InvalidArgumentException('non-nullable droplets cannot be null');
        }
        $this->container['droplets'] = $droplets;
     ...
     * Sets service
     *
     * @param string|null $service Service is the `namespace/name` of the live type=LoadBalancer Service that claims this load balancer, proven from the cluster scan. Non-empty means IN USE.
     *
     * @return self
     */
     ...
     * Sets size_unit
     *
     * @param int|null $size_unit size_unit
     *
     * @return self
     */
    public function setSizeUnit($size_unit)
    {
        if (is_null($size_unit)) {
            throw new \InvalidArgumentException('non-nullable size_unit cannot be null');
        }
