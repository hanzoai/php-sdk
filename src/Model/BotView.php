 ...
 */
class BotView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'botView';
    ...
    */
     ...
     * Sets agent
     *
     * @param string|null $agent Agent is the cloud Agent this machine runs, lifted out of the binding so a list of bots reads without following one. Empty means the machine is a bot machine with nothing bound — it costs money and answers nothing.
     *
     * @return self
     */
