 ...
 */
class ArgoMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'argoMeta';
    ...
    */
     ...
     *
     * @param string|null $creation_timestamp CreationTimestamp is when the source object was created, RFC 3339 to the second. Empty for a synthesized project.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name is the projected object's name: the App CR's metadata.name for an application, the CD Application's name for a CD row, and the IAM project name for a project.
     *
     * @return self
     */
     ...
     * Sets namespace
     *
     * @param string|null $namespace Namespace is the namespace the source object was read from — the tenant or platform namespace for an App CR, CD's controller namespace for a CD row. Empty for a project synthesized here, which lives in no namespace.
     *
     * @return self
     */
     ...
     * Sets uid
     *
     * @param string|null $uid UID is the k8s metadata.uid of the source object, which is what the SPA keys a row on across refreshes. Empty for a synthesized project — there is no object to take one from.
     *
     * @return self
     */
