...
class History implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets at
     *
     * @param string|null $at At is the token this is the history of, lowercased.
     *
     * @return self
     */
     ...
     * Sets days
     *
     * @param \Hanzo\Cloud\Model\Day[]|null $days Days is oldest first, which is the order a chart draws. `[]` for a token the indexer holds no day for, `null` where the read failed.
     *
     * @return self
     */
