...
class BillingAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets role
     *
     * @param string|null $role Role is the caller's standing. Absent when nobody was named, so an anonymous read returns an account rather than an implied membership.
     *
     * @return self
     */
