...
class NodeList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets nodes
     *
     * @param \Hanzo\Cloud\Model\MachineView[]|null $nodes Nodes is one row per worker node, in the SAME machineView shape the machines surface emits — a node IS a machine.
     *
     * @return self
     */
