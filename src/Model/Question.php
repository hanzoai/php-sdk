...
class Question implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount
     *
     * @param string|null $amount formatted figure ($…)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id the source transaction id it concerns
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string|null $kind outlier|reversal|roundoff|uncosted|overdrawn
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text the specific question to ask the founder
     *
     * @return self
     */
