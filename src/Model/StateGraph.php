 ...
 */
class StateGraph implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'stateGraph';
    ...
    */
     ...
     * Sets initial
     *
     * @param string|null $initial Initial is the state a fresh document starts in — \"draft\". A stored document with no status at all is read as this too.
     *
     * @return self
     */
     ...
     * Sets live
     *
     * @param string|null $live Live is the ONE state that is publicly readable — \"published\". The site pulls only documents in it, so reaching Live IS site-publish; every other state is invisible to a reader.
     *
     * @return self
     */
     ...
     * Sets states
     *
     * @param string[]|null $states States is every lifecycle state in canonical order: draft, in_review, approved, queued, published, archived. The console lays its board columns out in exactly this order, so the order is part of the answer.
     *
     * @return self
     */
