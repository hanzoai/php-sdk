...
/**
 * O11yAzureLogsCollectionStrategy Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class O11yAzureLogsCollectionStrategy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'o11y.AzureLogsCollectionStrategy';
    ...
    */
     ...
     *
     * @param string[]|null $category_groups List of categories to enable for diagnostic settings, to start with it will have 'allLogs' and no filtering.
     *
     * @return self
     */
