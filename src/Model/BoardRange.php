 ...
 */
class BoardRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BoardRange';
    ...
    */
     ...
     * Sets end
     *
     * @param string|null $end RFC3339 (UTC)
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param string|null $interval hour | day
     *
     * @return self
     */
     ...
     * Sets range
     *
     * @param string|null $range echoed label (24h | 7d | 30d | custom)
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param string|null $start RFC3339 (UTC)
     *
     * @return self
     */
