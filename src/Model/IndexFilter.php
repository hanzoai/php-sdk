 ...
 */
class IndexFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'indexFilter';
    ...
    */
     ...
     *
     * @param string[]|null $filterable_attributes FilterableAttributes replaces the whole filterable set. Omitted leaves it unchanged; an empty array clears it.
     *
     * @return self
     */
