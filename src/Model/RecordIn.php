 ...
 */
class RecordIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recordIn';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['room'] === null) {
            $invalidProperties[] = "'room' can't be null";
        }
