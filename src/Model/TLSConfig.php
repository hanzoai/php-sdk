 ...
 */
class TLSConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TLSConfig';
    ...
    */
     ...
     * Sets acme_email
     *
     * @param string|null $acme_email ACMEEmail is the ACME account email. It binds an account for the lifetime of an edge process, so it applies only when the edge (re)starts.
     *
     * @return self
     */
     ...
     * Sets extra_hosts
     *
     * @param string[]|null $extra_hosts ExtraHosts get certificates without owning a route — at most 256. They feed the ACME HostPolicy and hot-apply on the next reload.
     *
     * @return self
     */
     ...
     * Sets staging
     *
     * @param bool|null $staging Staging issues from Let's Encrypt's staging directory (untrusted certs, high rate limits). Like ACMEEmail it applies only when the edge (re)starts.
     *
     * @return self
     */
