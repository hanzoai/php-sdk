...
class Workflow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'owner' => 'setOwner',
        'question_template' => 'setQuestionTemplate',
        'text' => 'setText',
        'text2' => 'setText2'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('question_template', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets question_template
     *
     * @return string|null
     */
    public function getQuestionTemplate()
    {
        return $this->container['question_template'];
    }

    /**
     * Sets question_template
     *
     * @param string|null $question_template question_template
     *
     * @return self
     */
    public function setQuestionTemplate($question_template)
    {
        if (is_null($question_template)) {
            throw new \InvalidArgumentException('non-nullable question_template cannot be null');
        }
        $this->container['question_template'] = $question_template;
