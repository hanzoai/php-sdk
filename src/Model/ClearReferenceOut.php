...
/**
 * ClearReferenceOut Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class ClearReferenceOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClearReferenceOut';
    ...
    */
     ...
     * Sets cleared
     *
     * @param bool|null $cleared Cleared is false when your org held no such override — which is not an error, it is the honest answer to a removal that had nothing to remove.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key Key is the entry named.
     *
     * @return self
     */
     ...
     * Sets overrides
     *
     * @param int|null $overrides Overrides is how many your org still holds in this set.
     *
     * @return self
     */
     ...
     * Sets set
     *
     * @param string|null $set Set is the set cleared in.
     *
     * @return self
     */
