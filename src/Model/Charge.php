...
class Charge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount_cents
     *
     * @param int|null $amount_cents AmountCents is what this line costs.
     *
     * @return self
     */
     ...
     * Sets as_of
     *
     * @param string|null $as_of AsOf is when a pass-through amount was last checked against its source.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Code names the line so a caller can branch on it without reading prose.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label Label is what the payer sees on the invoice.
     *
     * @return self
     */
     ...
     * Sets pass_through
     *
     * @param bool|null $pass_through PassThrough marks money we collect and remit rather than keep — the state's fee is not our revenue, and a quote that hides that is a quote that reads as a bigger margin than it is.
     *
     * @return self
     */
     ...
     * Sets recurring
     *
     * @param string|null $recurring Recurring marks a line that repeats. An agent of record is billed every year for as long as the entity stands, and a payer agreeing to a one-time total is not agreeing to that.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source Source names who publishes this amount, for a line we merely pass through. Empty for a price of ours, which needs no external authority.
     *
     * @return self
     */
     ...
     * Sets stale
     *
     * @param bool|null $stale Stale reports that AsOf is older than the review window — the figure may have moved and nobody has looked. It does not block; it tells.
     *
     * @return self
     */
