...
/**
 * CaptableCompanyUpdate Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class CaptableCompanyUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'captableCompanyUpdate';
    ...
    protected static $openAPITypes = [
        'incorporation_country' => 'mixed',
        'incorporation_state' => 'mixed',
        'incorporation_type' => 'mixed',
        'name' => 'mixed'
    ];
    ...
    */
     ...
     *
     * @param mixed|null $incorporation_country incorporation_country
     *
     * @return self
     */
    public function setIncorporationCountry($incorporation_country)
    {
        if (is_null($incorporation_country)) {
            array_push($this->openAPINullablesSetToNull, 'incorporation_country');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('incorporation_country', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param mixed|null $incorporation_state incorporation_state
     *
     * @return self
     */
    public function setIncorporationState($incorporation_state)
    {
        if (is_null($incorporation_state)) {
            array_push($this->openAPINullablesSetToNull, 'incorporation_state');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('incorporation_state', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $incorporation_type incorporation_type
     *
     * @return self
     */
    public function setIncorporationType($incorporation_type)
    {
        if (is_null($incorporation_type)) {
            array_push($this->openAPINullablesSetToNull, 'incorporation_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('incorporation_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
