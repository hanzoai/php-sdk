 ...
 */
class ReadingView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'readingView';
    ...
    */
     ...
     * Sets confidence
     *
     * @param string|null $confidence Confidence says whether the counters that remain mean anything, as the meter graded itself.
     *
     * @return self
     */
     ...
     * Sets machine
     *
     * @param string|null $machine Machine is the machine the collector observed the account on.
     *
     * @return self
     */
     ...
     * Sets resets_at
     *
     * @param string|null $resets_at ResetsAt is when the window resets, RFC 3339 UTC.
     *
     * @return self
     */
     ...
     * Sets window_start
     *
     * @param string|null $window_start WindowStart is when the measured window opened, RFC 3339 UTC.
     *
     * @return self
     */
