...
class Holding implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets cost_cents
     *
     * @param int|null $cost_cents wholesale cost
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain the name owned
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param string|null $expires_at when the registration lapses, RFC3339
     *
     * @return self
     */
     ...
     * Sets nameservers
     *
     * @param string[]|null $nameservers the authoritative nameservers the name points at
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param int|null $order registrar order id
     *
     * @return self
     */
     ...
     * Sets org
     *
     * @param string|null $org the org that owns the domain
     *
     * @return self
     */
     ...
     * Sets price_cents
     *
     * @param int|null $price_cents what the customer paid (sell)
     *
     * @return self
     */
     ...
     * Sets registered_at
     *
     * @param int|null $registered_at unix seconds
     *
     * @return self
     */
