...
class Capabilities implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets group
     *
     * @param bool|null $group Group is whether the transport carries multi-person rooms — a Discord guild channel, a Slack channel, a Teams channel or group chat, a Telegram group or supergroup. False on whatsapp alone, which has no such room to carry.
     *
     * @return self
     */
