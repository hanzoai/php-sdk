...
/**
 * CollabPayload Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class CollabPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'collabPayload';
    ...
    */
     ...
     * Sets content
     *
     * @param array<string,string>|null $content Content maps a document field to its ProseMirror markup JSON.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source Source is the blob ref a getContent reads the snapshot from. Absent means there is no snapshot to read, which answers empty content.
     *
     * @return self
     */
