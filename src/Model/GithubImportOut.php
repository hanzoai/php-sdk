...
/**
 * GithubImportOut Class Doc Comment
 *
 * @category Class
 * @package  Hanzo\Cloud
 * @author   OpenAPI Generator team
 ...
 */
class GithubImportOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'githubImportOut';
    ...
    */
     ...
     * Sets queued
     *
     * @param int|null $queued Queued is how many repositories were handed to the background importer.
     *
     * @return self
     */
     ...
     * Sets repos
     *
     * @param string[]|null $repos Repos names those repositories, in the installation's listing order.
     *
     * @return self
     */
