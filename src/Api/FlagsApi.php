...
class FlagsApi
{
    ...
    /**
     * Operation getFlagsWaitlist
     *
     * Reports whether ONE host is currently gated by the launch waitlist.
     *
     * @param  string|null $host Host is the host to resolve, e.g. \&quot;chat.hanzo.ai\&quot;. Defaults to the request&#39;s own Host header when omitted, which is what lets a guard running on the governed host ask about itself with no argument. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFlagsWaitlist'] to see the possible values for this operation
     *
     * @throws \Hanzo\Cloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Hanzo\Cloud\Model\WaitlistModeView
     */
    public function getFlagsWaitlist($host = null, string $contentType = self::contentTypes['getFlagsWaitlist'][0])
    {
        list($response) = $this->getFlagsWaitlistWithHttpInfo($host, $contentType);
        return $response;
    }

    /**
     * Operation getFlagsWaitlistWithHttpInfo
     *
     * Reports whether ONE host is currently gated by the launch waitlist.
     *
     * @param  string|null $host Host is the host to resolve, e.g. \&quot;chat.hanzo.ai\&quot;. Defaults to the request&#39;s own Host header when omitted, which is what lets a guard running on the governed host ask about itself with no argument. (optional)
     ...
     * @throws \Hanzo\Cloud\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Hanzo\Cloud\Model\WaitlistModeView, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFlagsWaitlistWithHttpInfo($host = null, string $contentType = self::contentTypes['getFlagsWaitlist'][0])
    {
        $request = $this->getFlagsWaitlistRequest($host, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Hanzo\Cloud\Model\WaitlistModeView',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation getFlagsWaitlistAsync
     *
     * Reports whether ONE host is currently gated by the launch waitlist.
     *
     * @param  string|null $host Host is the host to resolve, e.g. \&quot;chat.hanzo.ai\&quot;. Defaults to the request&#39;s own Host header when omitted, which is what lets a guard running on the governed host ask about itself with no argument. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFlagsWaitlistAsync($host = null, string $contentType = self::contentTypes['getFlagsWaitlist'][0])
    {
        return $this->getFlagsWaitlistAsyncWithHttpInfo($host, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFlagsWaitlistAsyncWithHttpInfo
     *
     * Reports whether ONE host is currently gated by the launch waitlist.
     *
     * @param  string|null $host Host is the host to resolve, e.g. \&quot;chat.hanzo.ai\&quot;. Defaults to the request&#39;s own Host header when omitted, which is what lets a guard running on the governed host ask about itself with no argument. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFlagsWaitlistAsyncWithHttpInfo($host = null, string $contentType = self::contentTypes['getFlagsWaitlist'][0])
    {
        $returnType = '\Hanzo\Cloud\Model\WaitlistModeView';
        $request = $this->getFlagsWaitlistRequest($host, $contentType);
    ...
    /**
     * Create request for operation 'getFlagsWaitlist'
     *
     * @param  string|null $host Host is the host to resolve, e.g. \&quot;chat.hanzo.ai\&quot;. Defaults to the request&#39;s own Host header when omitted, which is what lets a guard running on the governed host ask about itself with no argument. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFlagsWaitlist'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFlagsWaitlistRequest($host = null, string $contentType = self::contentTypes['getFlagsWaitlist'][0])
    {



        $resourcePath = '/v1/flags/waitlist';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
